      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-12">
          ...
          >
            ...
            {t('notFound.searchComics')}
          </Link>
        </div>

        {/* Popular Genres Quick Links */}
        <div className="border-t border-gray-200 pt-8">
          <p className="text-sm text-gray-500 mb-4">{t('notFound.browseComics')}</p>
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            <Link
              href={`/${locale}/rankings?tab=popular`}
              className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors text-sm"
            >
              {t('rankings.mostPopular')}
            </Link>
            <Link
              href={`/${locale}/rankings?tab=new`}
              className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors text-sm"
            >
